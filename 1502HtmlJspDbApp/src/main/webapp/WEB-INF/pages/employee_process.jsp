...
<%!
	...
	public void jspInit() {
		...
		try {
			...
			pstmt1 = connection.prepareStatement("insert into employee_jsp(emp_name,emp_addr,emp_sal) values (?,?,?)");
			pstmt2 = connection.prepareStatement("select emp_id,emp_name,emp_addr,emp_sal from employee");
...
<%
String action = request.getParameter("si");
