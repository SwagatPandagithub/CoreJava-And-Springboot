...
<h1>Working with JSP implicit Objects</h1>
<h2>The context parameter Username is :: <%=application.getInitParameter("username") %></h2><br/>
<h2>The application name is :: <%=application.getServletContextName() %></h2><br/>
